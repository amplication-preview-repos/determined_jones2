...
import { AdminActionFindManyArgs } from "../../adminAction/base/AdminActionFindManyArgs";
import { AdminAction } from "../../adminAction/base/AdminAction";
...
export class UserControllerBase {
  ...
  async findAdminActions(
    ...
    const query = plainToClass(AdminActionFindManyArgs, request.query);
  ...
  async connectAdminActions(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: AdminActionWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      adminActions: {
        connect: body,
